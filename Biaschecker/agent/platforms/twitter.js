...
class TwitterSearch {
    ...
    async doLogin() {
        ...
        const LOGIN_INPUT_SELECTOR = 'input[name="text"]';
        const PASSWORD_INPUT_SELECTOR = 'input[type="password"]';
        // await this.page.waitFor(3000);
        await this.page.goto('https://twitter.com/login',{timeout:0});
        // await this.page.waitFor(3000);
        await this.page.waitForSelector(LOGIN_INPUT_SELECTOR,{timeout:0});
        ...
        await this.page.waitFor(500);
        // await this.page.click('div[class="css-901oao r-1awozwy r-6koalj r-18u37iz r-16y2uox r-37j5jr r-a023e6 r-b88u0q r-1777fci r-rjixqe r-bcqeeo r-q4m81j r-qvutc0"]');
        await this.page.keyboard.press('Enter');
        // await this.page.keyboard.press('Tab');
        await this.page.waitFor(30000);
        await this.page.waitForSelector(PASSWORD_INPUT_SELECTOR,30000);
        await this.page.waitFor(500);
    ...
    async doQuery(term) {
        ...
        await this.page.waitForSelector(SEARCH_INPUT_SELECTOR,{timeout:0});
    ...
    async doFollow(profile) {
        ...
        if (profile.substring(0, 4) == "http") {
            await this.page.goto(`${profile}`,{timeout:0});
            try {
            ...
            await this.page.goto(`https://twitter.com/${profile}`,{timeout:0});
            try {
